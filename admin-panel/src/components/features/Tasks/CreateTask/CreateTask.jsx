    ...
    <>
      ...
      >
        <div className={styles.panel}>
          <Link className={styles.panelLink} to="/todos">
            назад
          </Link>
        ...
        <div className={styles.selectBox}>
          ...
          <select
            className={classnames(
              `${styles.selectCreate} ${
                isDarkMode ? styles.selectCreateDark : ""
              }`
            )}
            id="user"
            name="user"
          ...
          >
            <option className={styles.optionFirst} value="">
        ...
        <button
          ...
          className={`${styles.btnSub} ${isDarkMode ? styles.btnSubDark : ""}`}
        >
          создать {">>>"}
        </button>
      </form>
