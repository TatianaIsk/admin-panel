  ...
  const filterTodos = () => {
    ...
    if (selectedStatus !== "") {
      filteredTodos = filteredTodos.filter(
        (todo) => todo.completed === (selectedStatus === "true")
      );
    }
          ...
          >
            ...
            <div className={styles.filters}>
              <select
                className={classnames(
                  `${styles.selectTask} ${
                    isDarkMode ? styles.selectTaskDark : ""
                  }`
                )}
                onChange={(e) => setSelectedUser(e.target.value)}
              >
                <option className={styles.optionTask} value="" defaultValue>
                  пользователь
                </option>
                {users.map((user) => (
              ...
              <select
                className={classnames(
                  `${styles.selectTodos} ${
                    isDarkMode ? styles.selectTodosDark : ""
                  }`
                )}
            ...
            <div className={styles.paginateBlock}>
              <Link
                ...
                className={classnames(
                  `${styles.btnCreate} ${
                    isDarkMode ? styles.btnCreateDark : ""
                  }`
                )}
              >
                Создать {">>>"}
              ...
              <p
                className={classnames(
                  `${styles.countRows} ${
                    isDarkMode ? styles.countRowsDark : ""
                  }`
                )}
              >
